 ...
 * @author amine
 */
public class EvenpropController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
     FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("evenprop.fxml"));
...
String formattedString = string.getDate_evenement().format(formatter);
        ...
        System.out.println(string.getPhoto());
        img.setImage(image);
    }
