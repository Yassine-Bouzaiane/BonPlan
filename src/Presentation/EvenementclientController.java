 ...
 /**
    ...
    { 
        mapview.addMapInializedListener(this);
          ...
          listview.getSelectionModel().selectedItemProperty().addListener((a,b,c)->mapInitialized());

    
      List<Evenement> ls = ps.afficherevenement1();
...
//                });  }
 ...
 @Override
    public void mapInitialized() 
    {
        ...
        LatLong pos;
        pos = new LatLong(se.afficherlatitude(selectedPerson),se.afficherlangitude(selectedPerson));     
