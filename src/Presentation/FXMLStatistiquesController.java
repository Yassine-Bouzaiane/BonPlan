...
//nbExp();
    ...
    {
        String req = "SELECT  et.nom_etablissement, count( id_exp)  from experience e , etablissement et where et.id_etablissement =e.id_etablissement AND et.id=? GROUP by et.id_etablissement";
