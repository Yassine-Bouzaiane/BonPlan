...
public class Client extends Utilisateur{
    ...
    public Client(int id_user, String nom, String prenom, String mot_de_passe, String username, String username_canonical,String email_canonical, int enable, String salt, int credentials_expired, String ville, int telephone, String genre, int locked, int expired, String region, int teliphone,String email) {
